...
class InitState extends State<Loginpage> {
  ...
  Widget loginpage() {
    ...
    void check_if_already_login() async {
      ...
      if (newuser == false) {
        Navigator.pushReplacement(
            context, new MaterialPageRoute(builder: (context) => Bilanpage()));
      }
    }
    ...
    void dispose() {
      ...
      authen.email.dispose();
      authen.password.dispose();
      super.dispose();
    }
